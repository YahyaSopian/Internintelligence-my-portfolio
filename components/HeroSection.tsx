...
const HeroSection = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col-reverse md:flex-row items-center justify-center text-center md:text-left px-6 md:px-12 bg-gray-100"
    >
      {/* Bagian Kiri: Teks */}
      <motion.div
      ...
      >
        ...
        <p className="text-gray-700 text-lg">
          ...
          yang memiliki semangat dalam membangun aplikasi web modern. Selain
          itu, saya juga seorang{" "}
          <span className="font-semibold text-blue-600">Guru Al-Qur'an </span>
          dan penulis blog yang membagikan ilmu dan pengalaman saya. Saya
          percaya bahwa teknologi dan ilmu agama dapat berjalan beriringan untuk
